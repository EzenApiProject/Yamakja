...
<section class="menu">
    <div class="container2">
        <div class="row justify-content-center logobar">
            <div class="col-lg-8">
...
<div class="buytotal">
    ...
    <section class="buyfinal">
        <table>
            <form>
                ...
                <tr class="cart__list__detail">
                    ...
                    <td><img class="cart-image" src="../imgs/items/1.jpg" alt=""></td>
                    <td><p><a href="#">호신용 티타늄 3단봉</a></p>
                    </td>
        ...
        <div class="amount"><p>89,800</p></div>
        <div class="amountbtn">
